                    ...
                    <ul class="page-sidebar-menu st_menu_new">
                        ...
                        <?php }else{ ?>
                                    ...
                                    <ul class="sub-menu item">
                                        <?php if(STUser_f::_check_service_available_partner('st_hotel')):?>
                                            <li class="<?php if($sc == 'dashboard-info' and STInput::request('type') == 'st_hotel' ) echo 'active' ?>">
                                                <a href="<?php  echo add_query_arg('type', 'st_hotel' , TravelHelper::get_user_dashboared_link($user_link, 'dashboard-info') ); ?>"><i class="fa fa-building-o"> &nbsp; </i><?php _e("Hotel Statistics",ST_TEXTDOMAIN) ?></a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if(STUser_f::_check_service_available_partner('st_hotel')):?>
                                            <li class="<?php if($sc == 'dashboard-info' and STInput::request('type') == 'hotel_room' ) echo 'active' ?>">
                                                <a href="<?php  echo add_query_arg('type', 'hotel_room' , TravelHelper::get_user_dashboared_link($user_link, 'dashboard-info') ); ?>"><i class="fa fa-building-o"> &nbsp; </i><?php _e("Room Statistics",ST_TEXTDOMAIN) ?></a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if(STUser_f::_check_service_available_partner('st_rental')):?>
                                            <li class="<?php if($sc == 'dashboard-info' and STInput::request('type') == 'st_rental' ) echo 'active' ?>">
                                                <a href="<?php  echo add_query_arg('type', 'st_rental' , TravelHelper::get_user_dashboared_link($user_link, 'dashboard-info') ); ?>"> <i class="fa fa-home"> &nbsp; </i><?php _e("Rental Statistics",ST_TEXTDOMAIN) ?></a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if(STUser_f::_check_service_available_partner('st_cars')):?>
                                            <li class="<?php if($sc == 'dashboard-info' and STInput::request('type') == 'st_cars' ) echo 'active' ?>">
                                                <a href="<?php  echo add_query_arg('type', 'st_cars' , TravelHelper::get_user_dashboared_link($user_link, 'dashboard-info') ); ?>"> <i class="fa fa-cab"> &nbsp; </i><?php _e("Car Statistics",ST_TEXTDOMAIN) ?></a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if(STUser_f::_check_service_available_partner('st_tours')):?>
                                            <li class="<?php if($sc == 'dashboard-info' and STInput::request('type') == 'st_tours' ) echo 'active' ?>">
                                                <a href="<?php  echo add_query_arg('type', 'st_tours' , TravelHelper::get_user_dashboared_link($user_link, 'dashboard-info') ); ?>"> <i class="fa fa-flag-o"> &nbsp; </i><?php _e("Tour Statistics",ST_TEXTDOMAIN)?></a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if(STUser_f::_check_service_available_partner('st_activity')):?>
                                            <li class="<?php if($sc == 'dashboard-info' and STInput::request('type') == 'st_activity' ) echo 'active' ?>">
                                                <a href="<?php  echo add_query_arg('type', 'st_activity' , TravelHelper::get_user_dashboared_link($user_link, 'dashboard-info') ); ?>"> <i class="fa fa-bolt"> &nbsp; </i><?php _e("Activity Statistics",ST_TEXTDOMAIN) ?></a>
                                            </li>
                                        <?php endif; ?>
                                    </ul>
                                </li>
                            ...
                            <li class="item <?php if($sc == 'overview') echo 'active' ?>">
                                <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'overview'); ?>"><i class="fa fa-user"></i><?php st_the_language( 'user_overview' ) ?></a>
                            </li>
                                        ...
                                        <li class="item <?php if(in_array($sc,array('create-hotel','edit-hotel','my-hotel','create-room','edit-room','my-room','booking-hotel','booking-hotel-room','add-hotel-room-booking','add-hotel-booking'))) echo "active" ?>">
                                            ...
                                            <ul class="sub-menu item">
                                                <li <?php if($sc == 'create-hotel')
                                                    echo 'class="active"' ?>>
                                                    <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'create-hotel'); ?>"><i class="fa fa-building-o">&nbsp;</i><?php st_the_language( 'user_create_hotel' ) ?>
                                                    </a>
                                                </li>
                                                <li <?php if($sc == 'my-hotel')
                                                    echo 'class="active"' ?>>
                                                    <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'my-hotel'); ?>"><i class="fa fa-building-o">&nbsp;</i><?php st_the_language( 'user_my_hotel' ) ?>
                                                    </a>
                                                </li>

                                                <li <?php if($sc == 'add-hotel-booking')
                                                    echo 'class="active"' ?>>
                                                    <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'add-hotel-booking'); ?>"><i class="fa fa-building-o">&nbsp;</i><?php _e( "Add Booking Hotel" , ST_TEXTDOMAIN ) ?>
                                                    </a>
                                                </li>
                                                <li <?php if($sc == 'booking-hotel')
                                                    echo 'class="active"' ?>>
                                                    <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'booking-hotel'); ?>"><i class="fa fa-building-o">&nbsp;</i><?php _e( "Booking Hotel" , ST_TEXTDOMAIN ) ?>
                                                    </a>
                                                </li>
                                                <li <?php if($sc == 'create-room')
                                                    echo 'class="active"' ?>>
                                                    <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'create-room'); ?>"><i class="fa fa-hotel">&nbsp;</i><?php st_the_language( 'user_create_room' ) ?>
                                                    </a>
                                                </li>
                                                <li <?php if($sc == 'my-room')
                                                    echo 'class="active"' ?>>
                                                    <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'my-room'); ?>"><i class="fa fa-hotel">&nbsp;</i><?php st_the_language( 'user_my_room' ) ?>
                                                    </a>
                                                </li>
                                                <li <?php if($sc == 'add-hotel-room-booking')
                                                    echo 'class="active"' ?>>
                                                    <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'add-hotel-room-booking'); ?>"><i class="fa fa-hotel">&nbsp;</i><?php _e( "Add Booking Room" , ST_TEXTDOMAIN ) ?>
                                                    </a>
                                                </li>
                                                <li <?php if($sc == 'booking-hotel-room')
                                                    echo 'class="active"' ?>>
                                                    <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'booking-hotel-room'); ?>"><i class="fa fa-hotel">&nbsp;</i><?php _e( "Booking Room" , ST_TEXTDOMAIN ) ?>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="item <?php if(in_array($sc,array('create-tours','edit-tours','my-tours','booking-tours', 'add-tour-booking'))) echo "active" ?>">
                                            ...
                                            <ul class="sub-menu item">
                                                ...
                                                <li <?php if($sc == 'add-tour-booking')
                                                    echo 'class="active"' ?>>
                                                    <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'add-tour-booking'); ?>"><i class="fa fa-flag-o">&nbsp;</i><?php _e( "Add Booking Tour" , ST_TEXTDOMAIN ) ?>
                                                    </a>
                                                </li>
                                        ...
                                        <li class="item <?php if(in_array($sc,array('create-activity','edit-activity','my-activity','booking-activity', 'add-activity-booking'))) echo "active" ?>">
                                            ...
                                            <ul class="sub-menu item">
                                                ...
                                                <li <?php if($sc == 'add-activity-booking')
                                                    echo 'class="active"' ?>>
                                                    <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'add-activity-booking'); ?>"><i class="fa fa-bolt">&nbsp;</i><?php _e( "Add Booking Activity" , ST_TEXTDOMAIN ) ?>
                                                    </a>
                                                </li>
                                        ...
                                        <li class="item <?php if(in_array($sc,array('create-cars','edit-cars','my-cars','booking-cars', 'add-car-booking'))) echo "active" ?>">
                                            ...
                                            <ul class="sub-menu item">
                                                ...
                                                <li <?php if($sc == 'add-car-booking')
                                                    echo 'class="active"' ?>>
                                                    <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'add-car-booking'); ?>"><i class="fa fa-cab">&nbsp;</i><?php _e( "Add Booking Car" , ST_TEXTDOMAIN ) ?>
                                                    </a>
                                                </li>
                                        ...
                                        <li class="item <?php if(in_array($sc,array('create-rental','edit-rental','my-rental','create-room-rental','my-room-rental','booking-rental', 'add-rental-booking'))) echo "active" ?>">
                                            ...
                                            <ul class="sub-menu item">
                                                ...
                                                <li <?php if($sc == 'add-rental-booking')
                                                    echo 'class="active"' ?>>
                                                    <a href="<?php echo TravelHelper::get_user_dashboared_link($user_link, 'add-rental-booking'); ?>"><i class="fa fa-home">&nbsp;</i><?php _e( "Add Booking Rental" , ST_TEXTDOMAIN ) ?>
                                                    </a>
                                                </li>
