    ...
    jQuery(function($){
        $(document).ready(function(){
            $(document).on('click','.btn-tp-search-flights', function(e){
                ...
                var form = $(this).closest('form');
                var required = false;
                if($('#location_origin').val() == ''){
                    required = true;
                    $('#location_origin').addClass('error');
                }else{
                    $('#location_origin').removeClass('error');
                }
                if($('#location_destination').val() == ''){
                    required = true;
                    $('#location_destination').addClass('error');
                }else{
                    $('#location_destination').removeClass('error');
                }
                ...
                var param = 'marker=' + marker + '&origin_iata=' + origin_iata +
            ...
            $(document).on('click','.btn-tp-search-hotels', function(e){
                ...
                var param = 'marker=' + marker + '&destination=' + destination +
                    '&checkIn=' + checkIn +
                    '&checkOut=' + checkOut +
                    '&adults=' + adults;
