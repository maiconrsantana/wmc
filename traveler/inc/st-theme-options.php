...
//        ),
    ...
    'settings' => array(
        ...
        array(
            ...
            'desc' => __('Choose the form of refund for partner<br/>Refund all for partner: When your booking is cancelled, the money will be refunded for partner completely', ST_TEXTDOMAIN),
            'type' => 'select',
            'choices' => array(
                array(
                    'value' => 'all',
        ...
        array(
            ...
            'section' => 'option_api_update',
            'condition' => 'tp_redirect_option:is(on)',
            'choices' => TravelHelper::get_pages_travelpayouts_api()
        ),
        array(
            'id' => 'tp_show_api_info',
        ...
        <li>
            ...
            <table width="95%" style="margin-left: 20px;">
                ...
                <tr>
                    ...
                    <td><em><?php echo __('Returns number of item set featured of the package', ST_TEXTDOMAIN); ?></em></td>
                </tr>
                <tr>
