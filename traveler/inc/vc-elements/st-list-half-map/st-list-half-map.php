...
if(class_exists( 'WPBakeryShortCode' ) and !class_exists( 'WPBakeryShortCode_st_list_half_map_field_hotel' )) {
    class WPBakeryShortCode_st_list_half_map_field_hotel extends WPBakeryShortCode
    {
...
if(class_exists( 'WPBakeryShortCode' ) and !class_exists( 'WPBakeryShortCode_st_list_half_map_field_rental' )) {
    class WPBakeryShortCode_st_list_half_map_field_rental extends WPBakeryShortCode
    {
        protected function content( $arg , $content = null )
        {
            global $st_form_search_advance_field_half_map;
...
if(class_exists( 'WPBakeryShortCode' ) and !class_exists( 'WPBakeryShortCode_st_list_half_map_field_car' )) {
    class WPBakeryShortCode_st_list_half_map_field_car extends WPBakeryShortCode
    {
        protected function content( $arg , $content = null )
        {
            global $st_form_search_advance_field_half_map;
...
if(class_exists( 'WPBakeryShortCode' ) and !class_exists( 'WPBakeryShortCode_st_list_half_map_field_tour' )) {
    class WPBakeryShortCode_st_list_half_map_field_tour extends WPBakeryShortCode
    {
        protected function content( $arg , $content = null )
        {
            global $st_form_search_advance_field_half_map;
...
if(class_exists( 'WPBakeryShortCode' ) and !class_exists( 'WPBakeryShortCode_st_list_half_map_field_activity' )) {
    class WPBakeryShortCode_st_list_half_map_field_activity extends WPBakeryShortCode
    {
        protected function content( $arg , $content = null )
        {
            global $st_form_search_advance_field_half_map;
...
if(class_exists( 'WPBakeryShortCode' ) and !class_exists( 'WPBakeryShortCode_st_list_half_map_field_range_km' )) {
    class WPBakeryShortCode_st_list_half_map_field_range_km extends WPBakeryShortCode
    {
        protected function content( $arg , $content = null )
        {
