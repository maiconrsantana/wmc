        ...
        class STRental extends TravelerObject
        {
            ...
            function __construct()
            {
                $this->orderby = [
                    ...
                    'name_a_z'   => [
                        'key'  => 'name_a_z',
                        'name' => __( 'Rental Name (A-Z)', ST_TEXTDOMAIN )
                    ],
                    'name_z_a'   => [
                        'key'  => 'name_z_a',
                        'name' => __( 'Rental Name (Z-A)', ST_TEXTDOMAIN )
                    ],
                ];
            }
...
//                    ";
            ...
            function do_add_to_cart()
            {
                ...
                $price_sale    = STPrice::getSalePrice( $item_id, strtotime( $check_in ), strtotime( $check_out ) );
