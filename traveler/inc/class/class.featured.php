<?php
    ...
    class STFeatured extends TravelerObject
    {
        ...
        static function get_featured( $id = null )
        {
            ...
            if ( !empty( $check_featured ) and $check_featured == 'on' ) {
                switch ( $feature_style ) {
                    case "simple":
                        return '<div class="feature_class st_featured_simple"><div>' . $feature_text . '</div></div>';
                        break;
                    case "label":
                        ...
                        return '<div class="feature_class st_featured_label"><div>' . $feature_text . '</div>' . $feature_star_div . '</div>';
                        break;
                    default :
                        return '<div class="feature_class st_featured">' . $feature_text . '</div>';
                        break;
                }
            }
        ...
        static function get_sale( $count_sale = false )
        {
