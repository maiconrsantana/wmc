<?php
    ...
    if ( !class_exists( 'STHotel' ) ) {
        class STHotel extends TravelerObject
        {
                    ...
                    if($start >0 && $end > 0){
                        ...
                        if(!empty($rooms)){
                            foreach($rooms as $key => $value){
                                $datarooms[] = $this->featch_dataroom($value['id'], $value['name'], $start, $end);
                            }
                        }
                        echo json_encode([
                            'status' => 1,
            ...
            public function featch_dataroom($post_id, $post_name, $start, $end){
                ...
                and avai.post_id = {$post_id} and avai.`status` = 'unavailable'";
