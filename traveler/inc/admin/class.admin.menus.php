<?php
    ...
    if ( !class_exists( 'STAdminMenu' ) ) {
        ...
        class STAdminMenu extends STAdmin
        {
            ...
            function admin_menu()
            {
                add_submenu_page( apply_filters( 'ot_theme_options_menu_slug', 'st_traveler_options' ), "Attributes", 'Attributes', 'manage_options', 'hotel_attributes', [ $this, 'attributes_page' ] );
            }
