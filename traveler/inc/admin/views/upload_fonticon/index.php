                            ...
                            foreach ( $list_fonts as $name => $list ):
                                ...
                                <tr>
                                    <td scope="col" colspan="2">
                                        <a href="<?php echo esc_url( admin_url( '?page=st-upload-custom-fonticon&listfont=' . $name ) ); ?>"><?php echo esc_html( $name ); ?></a>
                                        <div class="row-actions"><span class="delete">
                                                <a id="delete-custom-font"
                                                   href="<?php echo esc_url( admin_url( '?page=st-upload-custom-fonticon&deletefont=' . $name ) ); ?>">
