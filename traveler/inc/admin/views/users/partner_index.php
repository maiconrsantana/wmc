...
?>
<ul class="subsubsub">
    <li><a class="<?php if($st_tab=="partner") echo "current"; ?>" href="<?php echo admin_url("admin.php?page=st-users-list-partner-menu&st_tab=partner"); ?>"><?php _e("Partner",ST_TEXTDOMAIN) ?> </a> |</li>
    <li><a class="<?php if($st_tab=="partner_pending") echo "current"; ?>" href="<?php echo admin_url("admin.php?page=st-users-list-partner-menu&st_tab=partner_pending"); ?>"><?php _e("Partner Pending",ST_TEXTDOMAIN) ?></a> |</li>
    <li><a class="<?php if($st_tab=="partner_update") echo "current"; ?>" href="<?php echo admin_url("admin.php?page=st-users-list-partner-menu&st_tab=partner_update"); ?>"><?php _e("Partner Upgrade",ST_TEXTDOMAIN) ?> </a></li>
</ul>
...
<div class="tablenav top filter-admin-partner">
    <div class="alignleft actions bulkactions">
        ...
        <form id="posts-filter" action="<?php echo admin_url('admin.php?page=st-users-list-partner-menu')?>" method="get">
