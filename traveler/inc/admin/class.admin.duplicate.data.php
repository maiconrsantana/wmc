<?php
    ...
    if ( !class_exists( 'STDuplicateData' ) ) {
        class STDuplicateData extends STAdmin
        {
            ...
            {
                add_submenu_page( apply_filters( 'ot_theme_options_menu_slug', 'st_traveler_options' ), __( 'Upgrade Data', ST_TEXTDOMAIN ), __( 'Upgrade Data', ST_TEXTDOMAIN ), 'manage_options', 'st-upgrade-data', [ $this, '_st_duplicate_data_content' ] );
            }
