<?php
	...
	if ( !class_exists( 'STAdminUploadIcon' ) ) {
		...
		class STAdminUploadIcon extends STAdmin
		{
			...
			{
				add_submenu_page( apply_filters( 'ot_theme_options_menu_slug', 'st_traveler_options' ), __( 'Importer Fonticon', ST_TEXTDOMAIN ), __( 'Importer Fonticon', ST_TEXTDOMAIN ), 'manage_options', 'st-upload-custom-fonticon', [ $this, '_st_upload_icon_content' ] );
			}
