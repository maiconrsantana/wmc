        ...
        public function form( $instance ) {
            ...
            <p><label for="<?php echo $this->get_field_id('style') ; ?>"><?php echo __("Header style" , ST_TEXTDOMAIN) ; ?></label>
                <select id ="<?php echo $this->get_field_id('style') ; ?>" name="<?php echo $this->get_field_id('style') ; ?>">
                    <option value="" <?php if ($instance['style'] =="") echo "selected"; ?>>Default</option>
                    <option value="tour_box" <?php if ($instance['style'] =="tour_box") echo "selected"; ?>><?php echo __("Tour box style", ST_TEXTDOMAIN ) ; ?></option>
                </select>
            </p>
            <p><label for="<?php echo $this->get_field_id('post_type'); ?>"> <?php echo __("Choose a category", ST_TEXTDOMAIN ); ?>:<br>
                    <?php $hotel=new STHotel(); if($hotel->is_available()){?>
                        <?php
                    ...
                    <?php $rental=new STRental(); if($rental->is_available()){?>
                        <?php
                    ...
                    <?php $st_cars=new STCars(); if($st_cars->is_available()){?>
                        <?php
                    ...
                    <?php $st_tour=new STTour(); if($st_tour->is_available()){?>
                        <?php
                    ...
                    <?php $activity=STActivity::inst(); if($activity->is_available()){?>
                        <?php
