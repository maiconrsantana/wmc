...
<div data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-group input-daterange  form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <input id="field-st-checkin" class="form-control <?php echo esc_attr($is_required) ?>" name="start" type="text" placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" value="<?php echo STInput::get('start') ?>" />
</div>
