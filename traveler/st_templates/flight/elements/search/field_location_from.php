...
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <div class="st-select-wrapper st-flight-wrapper" >
        <input <?php echo $is_required; ?> id="location_from" type="text" class="form-control custom-flight-location st-location-name" autocomplete="off" data-name="<?php echo esc_html( $location_from ); ?>" value="" placeholder="<?php echo esc_html( $placeholder ); ?>">
    </div>
</div>