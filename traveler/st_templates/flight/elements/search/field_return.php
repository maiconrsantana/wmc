...
<div data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-group input-daterange  st-flight-to-field form-group-<?php echo esc_attr($field_size) ?> form-group-icon-left">
    ...
    <input id="field-hotel-checkout" placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-control <?php echo esc_attr($is_required) ?> checkout_hotel" value="<?php echo STInput::get('dd2') ?>" name="dd2" type="text" />
