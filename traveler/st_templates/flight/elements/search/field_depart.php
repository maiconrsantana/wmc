...
<div data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-group input-daterange form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <input id="field-hotel-checkin" placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-control checkin_hotel <?php echo esc_attr($is_required) ?>" value="<?php echo STInput::get('dd1') ?>" name="dd1" type="text" />
