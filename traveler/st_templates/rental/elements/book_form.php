        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group form-group-<?php echo esc_attr($field_size) ?> form-group-select-plus">
                    ...
                    <div class="btn-group btn-group-select-num <?php if($old>=4 || $adult_max < 4)echo 'hidden';?>" data-toggle="buttons">
                        <?php 
                    ...
                    <select id="field-rental-adult" class="form-control required <?php if($old<4 && $adult_max >= 4)echo 'hidden';?>" name="adult_number">
                        <?php 
