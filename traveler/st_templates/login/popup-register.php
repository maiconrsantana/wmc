            ...
            <div class="modal-body">
                ...
                <form class="register_form register_form_popup" method="post" action="<?php echo esc_url(add_query_arg(array( 'url'=>STInput::request('url') )))?>" >
                        ...
                        <div class="col-md-6 mt20">
                            <div class="checkbox checkbox-lg">
                                <label>
                                    ...
                                    <p class="text-muted"><?php echo __('Using for booking services', ST_TEXTDOMAIN); ?></p>
                            </div>
                        </div>
                        <div class="col-md-6 mt20">
                            <div class="checkbox checkbox-lg">
                                <label>
                                    ...
                                    <p class="text-muted"><?php echo __('Using for upload and booking services', ST_TEXTDOMAIN); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center mt20 btn-submit-form">
                        ...
                        <img  alt="loading" src="<?php echo esc_url(get_template_directory_uri().'/img/ajax-login.gif')?>">
                    </div>
                </form>
            </div>
        </div>
