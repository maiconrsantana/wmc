...
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <div class="st-select-wrapper tp-flight-wrapper" >
        <input <?php echo $is_required; ?> id="location_origin" type="text" data-locale="<?php echo esc_attr($locale_default); ?>" class="form-control tp-flight-location st-location-name" autocomplete="off" data-name="origin_iata" value="" placeholder="<?php echo esc_html( $placeholder ); ?>">
    </div>
</div>