...
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <div class="st-select-wrapper tp-hotel-wrapper" >
        <input <?php echo $is_required; ?> id="location_destination_h" type="text" data-text="<?php echo esc_html__('hotel(s)', ST_TEXTDOMAIN); ?>" data-locale="<?php echo esc_attr($locale_default); ?>" class="form-control tp-hotel-destination" autocomplete="off" data-name="destination" value="" placeholder="<?php echo esc_html( $placeholder ); ?>">
    </div>
</div>