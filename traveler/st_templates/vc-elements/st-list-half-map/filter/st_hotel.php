...
<form id="hotel_search_half_map" method="get" class="search main-search filter_search_map" action="<?php echo home_url() ?>">
    ...
    <?php if(!empty($form_search_advance)):?>
        ...
        <!--End search Advance-->
    <?php endif;?>
    <button class="btn btn-primary btn_search btn-lg" data-title="<?php st_the_language( 'search_for_hotel' ) ?>" type="submit"><?php st_the_language( 'search_for_hotel' ) ?></button>
</form>
