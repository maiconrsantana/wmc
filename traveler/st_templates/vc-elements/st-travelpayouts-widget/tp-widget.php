...
switch($widget_type){
    case 'popular-router':
        ...
        echo '<script async src="//www.travelpayouts.com/weedle/widget.js?width=400px&marker='.$marker.'&host='.$host.'&locale='.$language.'&currency=usd&destination='.$location.'" charset="UTF-8"></script>';
        break;
    case 'flights-map':
        $location = 'PAR';
        if(!empty($pr_destination['location_id'])){
