...
<div data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-group input-daterange form-group-<?php echo esc_attr($field_size) ?> form-group-icon-left">
    ...
    <input id="field-tour-checkout" class="form-control <?php echo esc_attr($is_required) ?>" name="end" type="text" value="<?php echo STInput::get('end') ?>"  placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" />
</div>