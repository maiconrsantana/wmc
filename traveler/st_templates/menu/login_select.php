    ...
    <?php else: ?>
         <?php echo '<'.esc_attr($container).' class="'.esc_attr($class_default).'">'; ?>    
            ...
            <ul class="list nav-drop-menu user_nav_big social_login_nav_drop" >
                ...
                <?php if($login_fb=="on"): ?>
                    <li class="social_img"><a onclick="return false" class="btn_login_fb_link login_social_link" href="<?php echo STSocialLogin::get_provider_login_url('Facebook') ?>"><img alt="<?php echo TravelHelper::get_alt_image(); ?>" src="<?php echo get_template_directory_uri()."/img/social/facebook-logo.jpg"; ?>"/></a></li>
                <?php endif;?>

                <?php if($login_gg=="on"): ?>
                    <li class="social_img"><a onclick="return false" class="btn_login_gg_link login_social_link" href="<?php echo STSocialLogin::get_provider_login_url('Google') ?>"><img alt="<?php echo TravelHelper::get_alt_image(); ?>" src="<?php echo get_template_directory_uri()."/img/social/google-plus.jpg"; ?>"/></a></li>
                <?php endif;?>

                <?php if($login_tw=="on"): ?>
                    <li class="social_img"><a onclick="return false" class="btn_login_tw_link login_social_link" href="<?php echo STSocialLogin::get_provider_login_url('Twitter') ?>"><img alt="<?php echo TravelHelper::get_alt_image(); ?>" src="<?php echo get_template_directory_uri()."/img/social/twitter-logo.png"; ?>"/></a></li>
                <?php endif;?>
                <?php }; ?>
            </ul>
        <?php echo  '</'.esc_attr($container).'>' ;?>
