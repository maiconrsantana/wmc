...
<form action="" method="post" enctype="multipart/form-data" id="st_form_add_partner">
    ...
    <div class="form-group form-group-icon-left">
        <label for="title" class="head_bol"><?php _e("Title",ST_TEXTDOMAIN) ?> <span class="text-small text-danger">*</span>:</label>
        <i class="fa  fa-file-text input-icon input-icon-hightlight"></i>
        <input id="st_title_car" name="st_title_car" type="text"
               placeholder="<?php _e("Title",ST_TEXTDOMAIN) ?>" class="form-control" value="<?php echo STInput::request("st_title_car",$title) ?>">
    ...
    <div  class="form-group form-group-icon-left hidden">
        <label for="st_content" class="head_bol"><?php st_the_language( 'user_create_car_content' ) ?> <span class="text-small text-danger">*</span>:</label>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="tab-car-details">
                <div class="row">
                    ...
                    <div class="col-xs-12" id="data_equipment_item">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 mb10">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="" name="equipment_item_title[]" type="text" class="tab-content-title form-control" value="<?php echo esc_html($v['title']) ?>">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 mb10">
                                                    <div class="form-group ">
                                                ...
                                                <div class="col-xs-12 mb10">
                                                    <div class="form-group ">
                                                        ...
                                                        <input id="cars_equipment_list_number" name="cars_equipment_list_number[]" type="text" class="form-control number" value="<?php if(isset($v['cars_equipment_list_number'])) echo esc_html($v['cars_equipment_list_number']) ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="tab-content">
                                                    <div class="row">
                                                        <div class="col-xs-12 mb10">
                                                            <div class="form-group">
                                                                <label for="policy_title"><?php _e( "Title" , ST_TEXTDOMAIN ) ?></label>
                                                                <input id="" name="equipment_item_title[]" type="text" class="tab-content-title form-control" value="<?php echo esc_html($v) ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-12 mb10">
                                                            <div class="form-group ">
                                                        ...
                                                        <div class="col-xs-12 mb10">
                                                            <div class="form-group ">
                                                                <label for="cars_equipment_list_number" ><?php _e("Number of item",ST_TEXTDOMAIN) ?></label>
                                                                <input id="cars_equipment_list_number" name="cars_equipment_list_number[]" type="text" class="form-control number" value="<?php echo esc_html($cars_equipment_list_number[$k]) ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <a href="javascript:void(0);" class="btn btn-primary add-list-item mt10" data-get-html="#list-item-equipment">+</a>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group form-group-icon-left">
                    ...
                    <div class="col-md-12">
                        <div class="form-group form-group-icon-left">
                            <label for="id_gallery"><?php _e( "Car gallery" , ST_TEXTDOMAIN ) ?> <span class="text-small text-danger">*</span>:</label>
            ...
            <div class="tab-pane fade  " id="tab-contact-details">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            <label for="id_logo"><?php _e("Manufacture logo",ST_TEXTDOMAIN) ?> <span class="text-small text-danger">*</span>:</label>
                            <div class="upload-wrapper upload-partner-wrapper">
                                <button class="upload-button-partner btn btn-primary btn-sm" data-uploader_title="<?php _e('Select a image to upload', ST_TEXTDOMAIN); ?>" data-uploader_button_text="<?php _e('Use this image', ST_TEXTDOMAIN); ?>"><?php echo __('Upload', ST_TEXTDOMAIN); ?></button>
                                <div class="upload-items">
                                    <?php 
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <label for="st_name"><?php _e("Car Manufacturer Name",ST_TEXTDOMAIN) ?> <span class="text-small text-danger">*</span>:</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <label for="email"><?php st_the_language( 'user_create_car_email' ) ?> <span class="text-small text-danger">*</span>:</label>
                            <i class="fa  fa-envelope-o input-icon input-icon-hightlight"></i>
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <label for="phone"><?php st_the_language( 'user_create_car_phone' ) ?> <span class="text-small text-danger">*</span>:</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="about"><?php _e('Info about car', ST_TEXTDOMAIN); ?> <span class="text-small text-danger">*</span>:</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-icon-left">
                            ...
                            <label for="price"><?php st_the_language( 'user_create_car_price' ) ?> <span class="text-small text-danger">*</span>:</label>
                    ...
                    <div class="data_price_by_number col-xs-12">
                        ...
                        <div class="content_data_price_by_number">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12 mb10">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="" name="st_title[]" type="text" class="tab-content-title form-control" value="<?php echo esc_html($v['title']) ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-12 mb10">
                                                            <div class="form-group form-group-icon-left">
                                    ...
                                    <?php if(!empty($st_price_by_number)){
                                        foreach($st_price_by_number as $k=>$v){
                                            if(!empty($v) and !empty($st_number_start[ $k ]) and !empty($st_number_end[ $k ])) {
                                                ...
                                                <div class="property-item tab-item">
                                                    <a href="javascript: void(0);" class="delete-tab-item btn btn-danger">x</a>
                                                    <div class="tab-title"><?php echo esc_html($st_title[$k]) ?></div>
                                                    <div class="tab-content">
                                                        <div class="row">
                                                            <div class="col-xs-12 mb10">
                                                                <div class="form-group">
                                                                    <label for=""><?php _e( "Title" , ST_TEXTDOMAIN ) ?></label>
                                                                    <input id="" name="st_title[]" type="text" class="tab-content-title form-control" value="<?php echo esc_html($st_title[$k]) ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-xs-12 mb10">
                                                                <div class="form-group form-group-icon-left">
                            ...
                            <a href="javascript:void(0);" class="btn btn-primary add-list-item mt10" data-get-html="#list-item-customprice">+</a>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group form-group-icon-left">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <label for="number_car"><?php _e("Number of cars for rent",ST_TEXTDOMAIN) ?> <span class="text-small text-danger">*</span>:</label>
                            <i class="fa fa-cogs  input-icon input-icon-hightlight"></i>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <label for="st_car_external_booking"><?php _e("External booking",ST_TEXTDOMAIN) ?>:</label>
                            <i class="fa fa-cogs input-icon input-icon-hightlight"></i>
                    ...
                    <div class='col-md-6 data_st_car_external_booking'>
                        <div class="form-group form-group-icon-left">
                            ...
                            <label for="st_car_external_booking_link"><?php _e("External booking URL",ST_TEXTDOMAIN) ?>:</label>
...
<div id="html_equipment_item" style="display: none">
    <div class="item">
        ...
        <div class="col-md-2">
            <div class="form-group ">
                <label for="cars_equipment_list_number" ><?php _e("Number of item",ST_TEXTDOMAIN) ?></label>
                <input id="cars_equipment_list_number" name="cars_equipment_list_number[]" type="text" class="form-control number" value="">
            </div>
        </div>
        <div class="col-md-1">
            <div class="form-group form-group-icon-left">
        ...
        <div class="tab-content">
            <div class="row">
                <div class="col-xs-12 mb10">
                    <div class="form-group">
                        <label for="policy_title"><?php _e( "Title" , ST_TEXTDOMAIN ) ?></label>
                        <input id="" name="equipment_item_title[]" type="text" class="tab-content-title form-control" value="">
                    </div>
                </div>
                <div class="col-xs-12 mb10">
                    <div class="form-group ">
                ...
                <div class="col-xs-12 mb10">
                    <div class="form-group ">
                        <label for="price_max"><?php _e("Price max",ST_TEXTDOMAIN) ?></label>
                        <input id="price_max" name="equipment_item_price_max[]" type="text" class="form-control number" value="">
                    </div>
                </div>
                <div class="col-xs-12 mb10">
                    <div class="form-group ">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 mb10">
                    <div class="form-group form-group-icon-left">
                        <label for="st_start_date"><?php _e("Number start",ST_TEXTDOMAIN) ?></label>
                        <i class="fa fa-calendar input-icon input-icon-hightlight"></i>
                        <input id="st_start_date"  name="st_number_start[]" type="text" placeholder="<?php _e("Number Start",ST_TEXTDOMAIN) ?>" class="form-control number" value="">
                    </div>
                </div>
                <div class="col-xs-12 mb10">
                    <div class="form-group form-group-icon-left">
                        ...
                        <label for="st_end_date"><?php _e("Number end",ST_TEXTDOMAIN) ?></label>
                        <i class="fa fa-calendar input-icon input-icon-hightlight"></i>
                        <input id="st_end_date"  name="st_number_end[]" type="text" placeholder="<?php _e("Number End",ST_TEXTDOMAIN) ?>" class="form-control number" value="">
                    </div>
                </div>
                <div class="col-xs-12 mb10">
                    <div class="form-group form-group-icon-left">
                        ...
                        <label for="st_price_by_number"><?php _e("Price",ST_TEXTDOMAIN) ?></label>
                        <i class="fa fa-money input-icon input-icon-hightlight"></i>
                        <input id="st_price_by_number" name="st_price_by_number[]" type="text" placeholder="<?php _e("Price",ST_TEXTDOMAIN) ?>" class="form-control number" value="">
                    </div>
                </div>
            </div>
        </div>
