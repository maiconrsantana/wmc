...
<form action="" method="post" enctype="multipart/form-data" id="st_form_add_partner">
    ...
    <div class="form-group form-group-icon-left">
        ...
        <input id="title" name="st_title" type="text"
               ...
               value="<?php echo STInput::request( "st_title", $title ) ?>">
    ...
    <div class="form-group">
        ...
        <textarea id="desc" rows="6" name="st_desc"
                  class="form-control"><?php echo STInput::request( "st_desc", $excerpt ) ?></textarea>
                    ...
                    <div class="col-md-6 clear">
                        <div class="form-group form-group-icon-left">
                            ...
                            <input id="phone" name="phone" type="phone"
                                   ...
                                   class="form-control"
                                   value="<?php echo STInput::request( 'contact_phone', get_post_meta( $post_id, 'contact_phone', true ) ) ?>">
                            <div
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <input id="website" name="website" type="text"
                                   ...
                                   class="form-control"
                                   value="<?php echo STInput::request( 'contact_web', get_post_meta( $post_id, 'contact_web', true ) ) ?>">
                        </div>
                        <div
                    ...
                    <div class="col-md-6 clear">
                        <div class="form-group form-group-icon-left">
                            ...
                            <select class="form-control deposit_payment_status" name="deposit_payment_status"
                                ...
                                <option
                                    value="amount" <?php if ( $deposit_payment_status == 'amount' ) echo 'selected' ?>><?php _e( "Deposit By Amount", ST_TEXTDOMAIN ) ?></option>
                            </select>
                        </div>
                    </div>
