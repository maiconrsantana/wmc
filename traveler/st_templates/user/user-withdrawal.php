    ...
    <div class="row st_partner_payout_item text-center">
        ...
        <div class="col-md-4">
            <div class="item-pay <?php if($st_partner_payout =='bank_transfer') echo "active";  ?>">
                <img alt="<?php echo TravelHelper::get_alt_image(); ?>" src="<?php echo get_template_directory_uri().'/img/user/banktransfer.png' ?>" class="img-thumbnail st_payout" />
            </div>
        ...
        <div class="col-md-4">
            <div class="item-pay <?php if($st_partner_payout =='paypal') echo "active";  ?>">
                <img alt="<?php echo TravelHelper::get_alt_image(); ?>" src="<?php echo get_template_directory_uri().'/img/user/paypal_logo.jpg' ?>" class="img-thumbnail active st_payout" />
            </div>
