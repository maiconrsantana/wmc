            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td style="padding: 6px;vertical-align: top;border-bottom:1px dashed #ccc;border-left: 1px solid #bcbcbc;border-bottom: 1px solid #bcbcbc;border-right: 1px solid #bcbcbc;">
                        ...
                        <p>
                            <strong><?php _e("Pick-up: " , ST_TEXTDOMAIN) ?></strong> <?php echo $pick_up ?>
                        </p>
                        <?php }?>

                        <?php if($drop_off=get_post_meta($order_code, 'drop_off', TRUE)){?>
                        <p>
                            <strong><?php _e("Drop-off: " , ST_TEXTDOMAIN) ?></strong> <?php echo $drop_off ?>
                        </p>
                        ...
                        <p>
                            <strong><?php _e("Driver’s Name: " , ST_TEXTDOMAIN) ?></strong> <?php echo $drive_name  ?>
                        </p>
                        <?php } ?>

                        <?php if($drive_age=get_post_meta($order_code, 'driver_age', TRUE)){?>
                        <p>
                            <strong><?php _e("Driver’s Age: " , ST_TEXTDOMAIN) ?></strong> <?php echo $drive_age ?>
                        </p>
                        <?php }?>
                        ...
                        <p>
                            ...
                            <ul>
                                ...
                                ?>
                                <li><?php echo $val->title .' ('. TravelHelper::format_money($val->price).')'; ?></li>
                                <?php endforeach; else: ?>
