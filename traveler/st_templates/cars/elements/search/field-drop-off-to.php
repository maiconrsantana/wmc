...
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <div class="st-select-wrapper">
        ...
        <select id="field-st-dropoff-to" name="location_id_drop_off" class="st-location-id st-hidden <?php echo esc_attr($is_required) ?>" placeholder="<?php if($placeholder) echo $placeholder; ?>" tabindex="-1">
            <option value=""></option>
            <?php 
