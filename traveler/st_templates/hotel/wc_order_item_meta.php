...
<ul class="wc-order-item-meta-list">
    ...
    <?php endif;?>    
    <?php if(isset($item_data['_st_room_num_search'])): $data=st_wc_parse_order_item_meta($item_data['_st_room_num_search']);?>
        <li>
            <span class="meta-label"><?php _e('Number of rooms:',ST_TEXTDOMAIN) ?></span>
            <span class="meta-data"><?php echo st_wc_parse_order_item_meta($item_data['_st_room_num_search']) ?></span>
            x
